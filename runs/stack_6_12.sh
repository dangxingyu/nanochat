...
# 2-phase stacking: 6 -> 12
# - Phase 1: Train d6 for 2 TPP of d12
# - Phase 2: Train d12 for 12 TPP of d12
...
STACKING_SCHEDULE="${STACKING_SCHEDULE:-6,1.0;12,10.5}"
N_EMBD="${N_EMBD:-768}"
...
WANDB_RUN="${WANDB_RUN:-stack_d6_d12}"
...
echo "=============================================="
echo "2-Phase Stack Training: 6 -> 12"
echo "=============================================="
...
echo ""
echo "Starting 2-phase stack training (6 -> 12)..."

TRAIN_ARGS=(
    --stacking-schedule="$STACKING_SCHEDULE"
    --n-embd=$N_EMBD
    --run=$WANDB_RUN
    --model-tag=${MODEL_TAG:-d12_stacked}
...
echo ""
echo "=============================================="
echo "2-phase stack training complete!"
echo "=============================================="
